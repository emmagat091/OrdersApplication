...
public class Form extends JFrame {
    ...
    private PanelOrdersView1Helper panelOrdersView1Helper11 = new PanelOrdersView1Helper();
    ...
    public void jbInit() throws Exception {
        ...
        panelOrdersView1Helper11.bindNestedContainer(panelBinding.findNestedPanelBinding("view_PanelOrdersView1Helper1PageDef"));
        dataPanel.setLayout(borderLayout1);
        this.getContentPane().setLayout(gridLayout);
        topPanel.setLayout(borderLayout);
        this.getContentPane().add(topPanel);
        this.setSize(new Dimension(630, 441));
        topPanel.add(navBar, BorderLayout.NORTH);
        dataPanel.add(panelOrdersView1Helper11, BorderLayout.NORTH);
